...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Printing shuffled seatCoyp");
        printList(seatCopy);
        System.out.println("Printing shuffled theater.seats");
        printList(theater.seats);
...
//        The two lines below do not work because the new list does not contain allocated seats (it has no references to seat objects)
