package com.example.musicuimigration.model;
...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:" + Paths.get("").toAbsolutePath() + File.separator + "MusicUIMigration" + File.separator + DB_NAME;
